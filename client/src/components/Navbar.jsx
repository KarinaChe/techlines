    ...
    <Box bg={useColorModeValue('gray.100','gray.900')} px={4}>
       <Flex h={16} alignItems='center' justifyContent='space-between'>
         ...
         <Flex alignItems='center'>
           ...
           <Button as={ReactLink} to='/registration' display={{base:'none', md:'inline-flex'}} m={2} fontSize='sm' fontWeight={600} _hover={{bg: 'orange.400'}} bg='orange.500' color='white'>Sign Up</Button>
         </Flex>
       </Flex>
